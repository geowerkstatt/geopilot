...
internal interface IConditionEvaluator
{
    ...
    /// <returns>Whether the condition matched, together with the raw values of the parameters the expression references.
    /// A non-boolean expression result counts as not matched. If the referenced expression parameters are not present, not matched.</returns>
