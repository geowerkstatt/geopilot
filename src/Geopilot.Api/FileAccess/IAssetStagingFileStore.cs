...
/// <summary>
/// Per-job file store for the delivery payload of a finished, deliverable job that has not been declared
...
/// <see cref="IAssetFileStore"/>, and a job that is never declared loses them with its retirement.
/// </summary>
