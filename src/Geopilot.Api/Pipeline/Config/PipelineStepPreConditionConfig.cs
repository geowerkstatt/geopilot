...
/// step should run or be marked as failed or skiped based on the current pipeline context and variables.
/// </summary>
...
{
    /// <summary>
    /// Gets or sets the boolean expression that determines whether the associated step should be skipped.
    /// </summary>
    /// <remarks>The condition is typically specified as a string expression evaluated at runtime. If the
    /// condition evaluates to <see langword="true"/>, the step will be skipped; otherwise, it will be executed.
