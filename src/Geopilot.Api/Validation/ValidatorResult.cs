...
/// <summary>
/// Represents the result of a validation as part of a validation job.
/// </summary>
/// <remarks>Used to be returned by IValidator implementations, but validators were replaced with pipelines.</remarks>
