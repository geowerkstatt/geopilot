...
public interface IGeopilotUserInfoService
{
    ...
    /// <param name="cancellationToken">Cancels the request to the identity provider.</param>
    ...
    Task<UserInfoResponse?> GetUserInfoAsync(string accessToken, CancellationToken cancellationToken = default);
}
