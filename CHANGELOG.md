...
- Short names can be defined as unique keys for mandates. These allow referring to a mandate from automated processing without relying on its database key.
