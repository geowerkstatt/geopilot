...
public class PipelineValidationTest
{
    ...
    [DataRow("invalidStepInputFromReference_01", new string[] { "PipelineConfig: Step 'validation' input 'iliFile' references 'zip.zip_package', but 'zip' is not an earlier step." }, DisplayName = "Step input references a later step")]
    [DataRow("invalidStepInputFromReference_02", new string[] { "PipelineConfig: Step 'validation' input 'iliFile' references 'invalidUploadStep.ili_file', but 'invalidUploadStep' is not an earlier step." }, DisplayName = "Step input references an unknown step")]
    ...
    [DataRow("invalidStepPostWarnCondition_01", new string[] { "PipelineConfig: pipeline 'ili_validation', invalid expression '[upload.foo] != null' on field Step-Post-Warn-Condition, parameter 'upload.foo' is not valid" }, DisplayName = "Step post warn condition is not valid (invalid parameter reference)")]
    [DataRow("invalidStepPostRestrictDeliveryCondition_01", new string[] { "PipelineConfig: pipeline 'ili_validation', invalid expression '[upload.foo] != null' on field Step-Post-Restrict-Delivery-Condition, parameter 'upload.foo' is not valid" }, DisplayName = "Step post restrict-delivery condition is not valid (invalid parameter reference)")]
