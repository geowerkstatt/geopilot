...
public class PipelineValidationTest
{
    ...
    [DataRow("invalidStepInputUnsupportedReference", new string[] { "PipelineConfig: Step 'validation': Reference '${uploads}' is not supported. Use ${step_output(stepId.outputName)}." }, DisplayName = "Step input has an unsupported reference")]
