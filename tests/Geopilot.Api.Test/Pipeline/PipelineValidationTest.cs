...
public class PipelineValidationTest
{
    ...
    [DataRow("noProcesses", "PipelineProcessConfig: The Processes field is required., StepConfig: process reference for 'ili_validator'", DisplayName = "No Processes")]
    ...
    [DataRow("noProcessId", "ProcessConfig: The Id field is required., StepConfig: process reference for 'ili_validator'", DisplayName = "Process has no Id")]
    ...
    [DataRow("unknownProcessImplementation", "ProcessConfig: unknown implementation 'this.is.unknown.ProcessorClass' for process 'ili_validator'", DisplayName = "Process has unknown implementation")]
    ...
    [DataRow("processNotUnique", "PipelineProcessConfig: duplicate process ids found: ili_validator", DisplayName = "Process has duplicate ids")]
